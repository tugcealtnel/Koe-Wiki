...
<body>
    <?php 
        if (@$_POST["submit"]) {
          ...
          $ekle = $db->prepare("INSERT INTO blog(baslik,alt_baslik,menu_adi,aciklama,aktif)VALUES(:baslik,:alt_baslik,:menu_adi,:aciklama,:aktif)");
          $ekle->bindValue(":baslik",$baslik, PDO::PARAM_STR);
          $ekle->bindValue(":alt_baslik",$alt_baslik, PDO::PARAM_STR);
          $ekle->bindValue(":menu_adi",$menu_adi, PDO::PARAM_STR);
                                    ...
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                             ...
                                             {
                                                echo '<option value="'.$row['menu_adi'].'" name="menu_adi" class="form-control">'.$row['menu_adi'].'</option>'; 
                                             }
